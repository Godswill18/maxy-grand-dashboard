...
export default function Announcements() {
  ...
  const getBranchName = (ann: Announcement) => {
    if (!ann.hotelId) return <span className="text-muted-foreground text-xs">Global</span>;
    if (typeof ann.hotelId === 'object') return ann.hotelId.name;
    return ann.hotelId;
  };
    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-xl sm:text-2xl font-bold">Announcements & Promotions</h1>
        </div>
                ...
                <TableBody>
                  {announcements.map((ann) => (
                    <TableRow key={ann._id}>
                      ...
                      <TableCell>{getBranchName(ann)}</TableCell>
                      <TableCell>
                      ...
                      <TableCell className="text-sm">{ann.priority}</TableCell>
                      <TableCell>
